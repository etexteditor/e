...
GotoFileDlg::ActionList::~ActionList(){
	delete m_tempEntry;
}
...
const FileEntry* GotoFileDlg::ActionList::GetSelectedAction() {
...
bool GotoFileDlg::ActionList::aItem::operator<(const aItem& ai) const {
