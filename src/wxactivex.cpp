...
void wxActiveX::CreateActiveX(REFCLSID clsid)
{
    ...
    ////////////////////////////////////////////////////////
	// FrameSite
    m_frameSite = new FrameSite(this);
    // oleClientSite
...
bool wxActiveX::MSWTranslateMessage(WXMSG* pMsg)
{
    if(m_frameSite)
    {
        LPMSG msg;
            ...
            msg->message == WM_KEYUP)
        {
            ...
            {
                if(msg->wParam == g_dangerKeys[keyI])
                {
...
HRESULT FrameSite::TranslateAccelerator(LPMSG lpmsg, WORD WXUNUSED(wID))
{
    ...
    if (m_window->m_oleInPlaceActiveObject.Ok())
    	return m_window->m_oleInPlaceActiveObject->TranslateAccelerator(lpmsg);
